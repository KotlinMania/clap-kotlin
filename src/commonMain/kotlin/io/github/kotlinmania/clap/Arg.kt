...
class Arg private constructor(
    ...
    fun short(short: Char): Arg = apply {
        shortName = short
    }

    fun long(long: String): Arg = apply {
        longName = long
    }

    fun action(action: ArgAction): Arg = apply {
        actionValue = action
    }

    fun help(help: String?): Arg = apply {
        helpValue = help
    }

    fun longHelp(help: String?): Arg = apply {
        longHelpValue = help
    }

    fun valueName(name: String?): Arg = apply {
        valueNameValue = name
    }

    fun valueParser(values: Iterable<PossibleValue>): Arg = apply {
    ...
    fun valueParserStrings(values: Iterable<String>): Arg = apply {
        possibleValuesList.clear()
    ...
    fun defaultValue(value: String?): Arg = apply {
    ...
    fun defaultValues(values: Iterable<String>): Arg = apply {
        defaultValuesList.clear()
    ...
    fun visibleAlias(alias: String): Arg = apply {
        visibleAliasesList += alias
    }

    fun visibleAliases(aliases: Iterable<String>): Arg = apply {
        visibleAliasesList += aliases
    }

    fun visibleAliases(aliases: Array<String>): Arg = visibleAliases(aliases.asIterable())

    fun visibleShortAlias(alias: Char): Arg = apply {
        visibleShortAliasesList += alias
    }

    fun visibleShortAliases(aliases: Iterable<Char>): Arg = apply {
        visibleShortAliasesList += aliases
    }

    fun visibleShortAliases(aliases: CharArray): Arg = visibleShortAliases(aliases.asIterable())

    fun required(yes: Boolean): Arg = apply {
        requiredValue = yes
    }

    fun index(index: Int): Arg = apply {
        indexValue = index
    }

    fun valueHint(valueHint: ValueHint): Arg = apply {
