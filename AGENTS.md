...
This file is the quick-reference operating contract for clap-kotlin. The longer
...
clap-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`clap`](https://crates.io/crates/clap). Upstream Rust is the behavioral oracle while the
