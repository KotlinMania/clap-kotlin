...
kotlin {
    ...
    val xcf = XCFramework("Clap")

    macosArm64 {
        binaries.framework { baseName = "Clap"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Clap"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Clap"
        flattenPackage = "io.github.kotlinmania.clap"
    }

    android {
        namespace = "io.github.kotlinmania.clap"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "clap-kotlin", version.toString())

    pom {
        name.set("clap-kotlin")
        description.set("Kotlin Multiplatform port of clap-rs/clap - A simple to use, efficient, and full-featured Command Line Argument Parser")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/clap-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/clap-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/clap-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/clap-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.clap.codeql
